; ==================================================================
; InterDOS -- The Inter Disk Operating System kernel
; Copyright (C) 2022 InterDOS Developers -- see doc/LICENSE.TXT
;
...
option_screen:
	...
	os_init_msg		db 'Welcome to MineOS', 0
	os_version_msg		db 'Version ', MIKEOS_VER, 0

	dialog_string_1		db 'Please select user interface :', 0
	dialog_string_2		db 'OK for enter program menu, Cancel', 0
	dialog_string_3		db 'for enter the MineDOS', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute MineOS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of MineOS, and', 0
